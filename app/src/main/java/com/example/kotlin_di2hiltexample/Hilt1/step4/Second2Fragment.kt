package com.example.kotlin_di2hiltexample.Hilt1.step4
...
import com.example.kotlin_di2hiltexample.databinding.FragmentSecond2Binding
...
class Second2Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d("MyLog", "Second2Fragment instance id: $wiFiManager")
